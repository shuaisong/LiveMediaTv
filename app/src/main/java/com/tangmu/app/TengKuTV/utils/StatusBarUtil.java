...
//                        | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
    ...
    public static boolean isHuaweiNotch(Context context) {
        ...
        try {
            ...
            Log.e("intro_info", "hasNotchInScreen ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            Log.e("intro_info", "hasNotchInScreen NoSuchMethodException");
        } catch (Exception e) {
            Log.e("intro_info", "hasNotchInScreen Exception");
        }
        return ret;
    }
