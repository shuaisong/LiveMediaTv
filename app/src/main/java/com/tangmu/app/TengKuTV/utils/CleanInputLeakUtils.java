...
public class CleanInputLeakUtils {
    private static CleanInputLeakUtils utils = new CleanInputLeakUtils();
        public static CleanInputLeakUtils getInstance(){
            return utils;
        }

    private CleanInputLeakUtils() {
    }
    ...
    public   void fixInputMethodManagerLeak(Context destContext) {
        ...
        for (String view : viewArray) {
            try {
                ...
                if (filedObject instanceof View) {
